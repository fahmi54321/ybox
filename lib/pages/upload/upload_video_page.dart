import 'package:cloud_storage/pages/upload/pop_up_pilih_audio.dart';
import 'package:cloud_storage/pages/upload/pop_up_pilih_video.dart';
...
class UploadVideoPage extends StatefulWidget {
  static const ROUTE = 'upload_video_page';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              state.listVideo.isEmpty ? emptyData() : listVideo(),
              const SizedBox(height: 50),
              VCustomBoxWidget(
                  onTap: () async {
                    final pilihVideo = await showPilihVideo(context);
                    if (pilihVideo != null) {
                      // ambil file
                      // final file = await VUtils.getBase64Photo(flag: pilihVideo);
                      // if (file != null && file != '') {
                      //   // ambil audio
                      // }
                    }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          vText(
            "Silahkan menambah video dengan tap tombol dibawah",
            ...
            children: [
              ClipRRect(
                ...
                child: Image(
                    ...
                    fit: BoxFit.cover,
                    image: FileImage(state.listVideo[i])),
              ),
              Positioned(
                right: 0,
                top: 0,
