...
class UploadAudioPage extends StatefulWidget {
  static const ROUTE = 'upload_audio_page';
...
class _UploadAudioPageState extends State<UploadAudioPage> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              state.listAudio.isEmpty ? emptyData() : listAudio(),
              const SizedBox(height: 50),
              VCustomBoxWidget(
                  onTap: () async {
                    final pilihAudio = await showPilihAudio(context);
                    if (pilihAudio != null) {
                      // ambil file
                      final file =
                          await VUtils.getBase64Photo(flag: pilihAudio);
                      if (file != null && file != '') {
                        // ambil audio
                      }
                    }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          vText(
            "Silahkan menambah audio dokumentasi dengan tap tombol dibawah",
  ...
  listAudio() {
    return GridView.builder(
      ...
      shrinkWrap: true,
      itemCount: state.listAudio.length,
      itemBuilder: (c, i) {
        return Padding(
            ...
            children: [
              ClipRRect(
                ...
                child: Image(
                    ...
                    fit: BoxFit.cover,
                    image: FileImage(state.listAudio[i])),
              ),
              Positioned(
                right: 0,
                top: 0,
