...
import 'package:cloud_storage/pages/home/fragment/video_fragment_state.dart';
...
class VideoFragmentState extends State<VideoFragment> {
  late VideoFragmentStates state;
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => VideoFragmentStates(context: context),
      child: Consumer(
                ...
                child: FloatingActionButton.small(
                  onPressed: () {
                    Navigator.pushNamed(context, MainFormPage.ROUTE,
                        arguments: ArgsMainFormPage(
                            titleAppBar: 'Video', formCode: 'video'));
                  },
